...
<html>
<head>
	<title>Webstats Registration Page</title>
...
<body>
	...
	<div id="background">
		...
		<div id="loginContainer">
			...
			<div id="inputContainer">
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<p>
						...
						<label for="username">Username</label>                         <!--visitor_id is username-->
			...
			<div id="loginText">
				<h1 style="color:#fff">Webstats</h1>
				<h2>Features</h2>
				<ul>
					<li>Optimized Search engine</li>
					<li>Get visitor's info</li>
					<li>Get visitor's timestamp</li>
					<li>Display no. of visitors and developers</li>
				</ul>
			</div>
